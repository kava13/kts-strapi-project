...
export interface ApiSpecialitySpeciality extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    rich_blocks: Schema.Attribute.Blocks;
    slug: Schema.Attribute.UID;
    speciality_link: Schema.Attribute.Component<'blocks.ssylka', false>;
    students: Schema.Attribute.Relation<'oneToMany', 'api::student.student'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    zones: Schema.Attribute.DynamicZone<['blocks.ssylka', 'blocks.kartochka']>;
  };
}
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    birthday_date: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
